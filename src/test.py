...
def go_fetch(url):
    ...
    if content_type is None or content_type not in all_valid_types:
        ...
        print("It worked!", "Content-Type", content_type)

url ="https://static.wikia.nocookie.net/leagueoflegends/images/6/68/Shurima_The_Ruins_Of_Shurima.jpg/revision/latest/scale-to-width-down/1000?cb=20180917145545"
go_fetch(url)
